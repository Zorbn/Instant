...
// Generated by https://github.com/heisluft/Beef-OpenGL-Header-Generator for OpenGL 3.2.
// Modified to add this comment as well as change the namespace and class names.
namespace OpenGL
{
	static class GL
	{
		...
		public static function void(bool red, bool green, bool blue, bool alpha) glColorMask;
		public static function void(uint32 index, bool r, bool g, bool b, bool a) glColorMaski;
		...
		public static function void(TriangleFace mode) glCullFace;
		...
		public static function void(bool flag) glDepthMask;
		...
		public static function void(BufferTargetARB target, uint32 index, bool* data) glGetBooleani_v;
		public static function void(GetPName pname, bool* data) glGetBooleanv;
		...
		public static function void(TriangleFace face, PolygonMode mode) glPolygonMode;
		...
		public static function void(float value, bool invert) glSampleCoverage;
		...
		public static function void(TriangleFace face, StencilFunction func, int32 reference, uint32 mask) glStencilFuncSeparate;
		public static function void(uint32 mask) glStencilMask;
		public static function void(TriangleFace face, uint32 mask) glStencilMaskSeparate;
		public static function void(StencilOp fail, StencilOp zfail, StencilOp zpass) glStencilOp;
		public static function void(TriangleFace face, StencilOp sfail, StencilOp dpfail, StencilOp dppass) glStencilOpSeparate;
		...
		public static function void(TextureTarget target, int32 samples, InternalFormat internalformat, int32 width, int32 height, bool fixedsamplelocations) glTexImage2DMultisample;
		...
		public static function void(TextureTarget target, int32 samples, InternalFormat internalformat, int32 width, int32 height, int32 depth, bool fixedsamplelocations) glTexImage3DMultisample;
		...
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix2fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix2x3fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix2x4fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix3fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix3x2fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix3x4fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix4fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix4x2fv;
		public static function void(int32 location, int32 count, bool transpose, float* value) glUniformMatrix4x3fv;
		...
		public static function void(uint32 index, int32 size, VertexAttribPointerType type, bool normalized, int32 stride, void* pointer) glVertexAttribPointer;
